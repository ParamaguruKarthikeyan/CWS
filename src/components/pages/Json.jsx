...
export default function Json() {
  ...
  const jsonData = {
    ...
    user: {
      ...
      followers_count: 48,
      profile_image_url:
        'http://a1.twimg.com/profile_images/455128973/gCsVUnofNqqyd6tdOGevROvko1_500_normal.jpg',
      listed_count: 0,
      profile_background_image_url:
  ...
  useEffect(() => {
    dispatch(CommonSlice.setTitle('JSON'));
  }, []);

  return (
    <>
      <h5 className="content-header">
        <i className="material-icons">code</i>JSON View
      </h5>
      <div className="row json-screen">
        <div className="json-container z-depth-1">
          <ReactJson src={jsonData} {...reactJsonProps} />
        </div>
      </div>
    </>
  );
